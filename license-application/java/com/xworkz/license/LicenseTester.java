...
public class LicenseTester {
	public static void main(String[] args) {
		...
		AddressDTO addressDTO = new AddressDTO(3254, "NA", 582116, "RR nagar", "Laxmeshwar", "Ka", "Na");
		...
		LicenseDTO dto = new LicenseDTO("Vena", 23, addressDTO, dob, 7829731400l, BloodGroup.AB_POSITIVE,
				Gender.FEMALE);
		dto.setIdProof(Idproof.ADHARCARD);
		dto.setIdProofNo("8124 3456 4111");
		...
		LicenseDTO dtoFound = dao.findByIdProofNo("8124 3456 4111");
		System.out.println(dtoFound);

		boolean updated=dao.updateVehicleTypeByIdProofNo("8124 3456 4111", VehicleType.LMV);
		System.out.println("updated "+ updated);
		
		LicenseDTO dtoafterUpdate=dao.findByIdProofNo("6363 8787 6449");
		System.out.println(dtoafterUpdate);
		
		boolean deleted=dao.deleteByIdProofNo("8124 4322 4111");
		System.out.println("deleted "+deleted);
		
		LicenseDTO dtoFound1 = dao.findByIdProofNo("8124 3456 4111");
		System.out.println(dtoFound);
